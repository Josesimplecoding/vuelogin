...
<template>
  <div class="flex flex-col items-center justify-center space-y-12 min-h-screen-nonav">Logged in: {{ isAuthenticated }}
    <div class="flex items-center justify-center overflow-hidden bg-gray-200 rounded-lg shadow-2xl ">
      ...
      <form @submit.prevent="logginIn" class="flex flex-col p-4 space-y-4">
        ...
        <button type="submit" @submit.prevent="logginIn" class="py-2 text-indigo-200 bg-indigo-600 rounded-lg">
          Login
        </button>
      </form>
    </div>
